...
Used for [status.hospitium.co](http://status.hospitium.co)

[![Build Status](https://secure.travis-ci.org/ninetwentyfour/hospitium-stashboard.png)](http://travis-ci.org/ninetwentyfour/hospitium-stashboard)
